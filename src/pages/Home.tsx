        ...
        faqItems={[
          {
            ...
            answer: "정식 사업자 등록 업체를 통한 소액결제 한도 활용은 불법이 아닙니다. 다만 미등록·과대광고 업체는 피해로 이어질 수 있어 주의가 필요합니다.",
          },
          {
            question: "이 사이트(.net)에서 바로 신청할 수 있나요?",
            answer: "이 사이트는 정보 제공용 가이드입니다. 실제 상담 신청은 고릴라티켓.com에서 진행해 주세요.",
          },
        ]}
      />
      <GuideHeroSection />
