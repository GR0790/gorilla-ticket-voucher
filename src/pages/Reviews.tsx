...
const Reviews: React.FC = () => {
  const reviews = [
    {
      ...
      rating: 5,
      content:
        "정말 급했는데 3분도 안되서 입금됐어요! 상담도 친절하시고 상품권 매입 최고입니다. 고릴라티켓 덕분에 잘 해결했어요. 다음에도 꼭 이용할게요!",
      amount: "50만원",
    },
    {
      id: 2,
      ...
      rating: 5,
      content:
        "타업체보다 상품권 매입 수수료도 저렴하고 입금도 빨라서 좋았어요. 다음에도 이용할게요! 안전한 고릴라티켓 찾아서 다행이에요.",
      amount: "80만원",
    },
    {
      id: 3,
      ...
      rating: 4,
      content:
        "상품권 매입 절차가 복잡할 줄 알았는데 고릴라티켓은 생각보다 간편하고 안전하게 처리해주셔서 감사합니다. 믿고 맡길 수 있겠어요.",
      amount: "100만원",
    },
    {
      id: 4,
      ...
      rating: 5,
      content:
        "문화상품권 매입 처음 해봤는데 설명도 자세히 해주시고 서비스가 좋아서 만족합니다. 24시간 상담 가능한 것도 너무 좋아요!",
      amount: "30만원",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      rating: 5,
      content:
        "해피머니 상품권 매입 처음 해봤는데 생각보다 간단하고 빨라서 놀랐어요. 서비스도 친절하고 좋았습니다.",
      amount: "25만원",
    },
  ];
  ...
  return (
    <>
      <SEO
        title="고객 후기"
        description="고릴라티켓 실제 고객 후기 1,247건. 상품권매입, 상품권매입, 상품권매입, 상품권매입 서비스 평균 평점 4.8점. 3분 입금, 24시간 상담 만족 후기를 확인하세요."
        keywords="고릴라티켓 후기, 상품권매입 후기, 상품권매입 후기, 상품권매입 후기, 상품권매입 후기"
      />
        ...
        <section className="bg-gradient-to-br from-sky-50 to-sky-100 py-12 md:py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              <br />
              상품권, 문화상품권, 해피머니, 상품권 매입 서비스에 대한 솔직한
              후기입니다.
            </p>
          </div>
        </section>
